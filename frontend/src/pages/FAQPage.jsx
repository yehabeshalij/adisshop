      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at derashshopping@gmail.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                derashshopping@gmail.com, or by calling us at +251 920 534 560
                or +251 938 946 937 between the hours of 3am and 11:30am EST,
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Comming soon other country and state
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept telebirr,chapa,santim pay ,mastercard payment method
                also we have cash on delivery system.
              </p>
            </div>
          )}
        </div>
